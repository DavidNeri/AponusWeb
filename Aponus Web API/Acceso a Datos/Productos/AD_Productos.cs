...
namespace Aponus_Web_API.Acceso_a_Datos.Productos
{
    public class AD_Productos
    {
        ...
        private readonly ComponentesProductos componentesProductos;
        public AD_Productos(AponusContext _aponusDbContext, ComponentesProductos _componentesProductos)
        {
