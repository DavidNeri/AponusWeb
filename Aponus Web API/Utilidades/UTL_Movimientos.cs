...
namespace Aponus_Web_API.Utilidades
{
    public class UTL_Movimientos
    {
        ...
        public Expression<Func<DTOMovimientosStock, bool>> ConstruirCondicionWhere(UTL_Movimientos filtros)
        {
            string Propiedad;
            ...
            var PropsNoNulas = typeof(UTL_Movimientos).GetProperties().Where(Prop => Prop.GetValue(filtros) != null);
