...
namespace AponusWebAPI.Migrations
{
    ...
    [Migration("20231219213144_Proveedores")]
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.Stock_Movimientos", b =>
                {
                    ...
                    b.Property<int?>("ID_PROVEEDOR_ORIGEN")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ProveedorDestinoIdProveedor")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ID_PROVEEDOR_ORIGEN");

                    b.HasIndex("ProveedorDestinoIdProveedor");
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.Stock_Movimientos", b =>
                {
                    b.HasOne("Aponus_Web_API.Models.Proveedores", "ProveedorOrigen")
                        .WithMany()
                        .HasForeignKey("ID_PROVEEDOR_ORIGEN");

                    b.HasOne("Aponus_Web_API.Models.Proveedores", "ProveedorDestino")
                        .WithMany()
                        .HasForeignKey("ProveedorDestinoIdProveedor");
