...
namespace AponusWebAPI.Migrations
{
    ...
    [Migration("20240513202202_Compras")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.Compras", b =>
                {
                    ...
                    b.Property<string>("UsuariosUsuario")
                        .HasColumnType("varchar(50)");

                    b.HasKey("IdCompra");

                    b.HasIndex("UsuariosUsuario");
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.ComprasDetalles", b =>
                {
                    ...
                    b.Property<string>("DetallesInsumoIdInsumo")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasIndex("DetallesInsumoIdInsumo");
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.MediosPago", b =>
                {
                    ...
                    b.Property<int?>("PagosComprasIdPago")
                        .HasColumnType("int");

                    b.HasKey("IdMedioPago");

                    b.HasIndex("PagosComprasIdPago");
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.Compras", b =>
                {
                    b.HasOne("Aponus_Web_API.Models.Usuarios", null)
                        .WithMany("Compras")
                        .HasForeignKey("UsuariosUsuario");
                });
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.ComprasDetalles", b =>
                {
                    ...
                    b.HasOne("Aponus_Web_API.Models.ComponentesDetalle", "DetallesInsumo")
                        .WithMany()
                        .HasForeignKey("DetallesInsumoIdInsumo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.MediosPago", b =>
                {
                    b.HasOne("Aponus_Web_API.Models.PagosCompras", null)
                        .WithMany("MediosPagos")
                        .HasForeignKey("PagosComprasIdPago");
                });
            ...
            modelBuilder.Entity("Aponus_Web_API.Models.PagosCompras", b =>
                {
                    b.HasOne("Aponus_Web_API.Models.Compras", null)
                        .WithMany("Pagos")
